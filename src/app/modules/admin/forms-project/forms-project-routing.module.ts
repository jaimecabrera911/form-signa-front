...
const routes: Routes = [
    {
        ...
        children: [
            ...
            {   path: 'sg-fr-08/view/:id', component: SGFR08Component },{   path: 'sg-fr-08/edit/:id', component: SGFR08Component },
            {   path: 'sg-lc-02', component: Sglc02Component },
            {   path: 'sg-lc-02/view/:id', component: Sglc02Component },{   path: 'sg-lc-02/edit/:id', component: Sglc02Component },
            {   path: 'sg-lc-31', component: Sglc31Component },
            {   path: 'sg-lc-31/view/:id', component: Sglc31Component },{   path: 'sg-lc-31/edit/:id', component: Sglc31Component },
            {   path: 'sg-lc-04', component: Sglc04Component },
            {   path: 'sg-lc-04/view/:id', component: Sglc04Component },{   path: 'sg-lc-04/edit/:id', component: Sglc04Component },
            {   path: 'sg-lc-25', component: Sglc25Component },
            {   path: 'sg-lc-25/view/:id', component: Sglc25Component },{   path: 'sg-lc-25/edit/:id', component: Sglc25Component },
            {   path: 'sg-lc-24', component: Sglc24Component },
            {   path: 'sg-lc-24/view/:id', component: Sglc24Component },{   path: 'sg-lc-24/edit/:id', component: Sglc24Component },
            {   path: 'sg-fr-86', component: Sgfr86Component },
            {   path: 'sg-fr-86/view/:id', component: Sgfr86Component },{   path: 'sg-fr-86/edit/:id', component: Sgfr86Component },
            {   path: 'sg-fr-78', component: Sgfr78Component },
            {   path: 'sg-fr-78/view/:id', component: Sgfr78Component },{   path: 'sg-fr-78/edit/:id', component: Sgfr78Component },
            {   path: 'sg-fr-32', component: Sgfr32Component },
            {   path: 'sg-fr-32/view/:id', component: Sgfr32Component },{   path: 'sg-fr-32/edit/:id', component: Sgfr32Component },
            {   path: 'sg-fr-76', component: Sgfr76Component },
            {   path: 'sg-fr-76/view/:id', component: Sgfr76Component },{   path: 'sg-fr-76/edit/:id', component: Sgfr76Component },
            {   path: 'sg-fr-56', component: Sgfr56Component },
            {   path: 'sg-fr-56/view/:id', component: Sgfr56Component },{   path: 'sg-fr-56/edit/:id', component: Sgfr56Component }
        ]
    }
];
